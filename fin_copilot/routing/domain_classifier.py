...
DOMAIN_KEYWORDS: dict[str, list[str]] = {
    "会话流程": [
        ...
        "招商银行", "交通银行", "邮政银行", "身份证",
        "能听到吗", "听得到吗", "喂喂", "在吗", "信号",
        "没别的了", "没其他问题", "谢谢", "感谢", "多谢", "辛苦了", "再见", "拜拜", "挂了",
    ],
    "会员": [
    ...
    "活动": [
        ...
        "推销", "别打电话", "不要推销", "还款无忧", "还款无忧服务",
        "还款无忧服务费", "债务咨询顾问服务费", "债务咨询顾问", "顾问服务费",
        "赋强公证", "加速卡", "拒就返", "贷前必查", "借钱必查",
        "话费券", "省话费", "权益月卡", "预约借款", "邀请好友",
        "豆豆分", "众惠", "百万医疗", "赚钱卡", "金钱卡", "月奖金",
        "订单宝", "续费", "非我司", "不是你们", "是不是你们", "哪个平台",
        "哪家公司", "哪个机构", "合作方", "合作关系", "第三方",
        "第三方平台", "外部平台", "外部APP", "别的平台", "扣款方",
        "商户名称", "服务商", "机构归属", "官方电话",
    ],
    "业务办理": [
