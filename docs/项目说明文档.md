...
当前 `skills/registry.json` 登记 55 个 Skill，覆盖 10 个业务域 + 1 个会话流程域。
...
| 活动     |    6 | `cancel_value_added_service`, `light_card_cancel_refund`, `non_company_product_inquiry`, `refund_value_added_service`, `stop_marketing`, `value_added_service_inquiry` |
